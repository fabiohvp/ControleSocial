...
export function createRollupConfigs(config) {
	...
	return [
		baseConfig(config, { dynamicImports: useDynamicImports }),
...
function baseConfig(config, ctx) {
	...
	const rollupConfig = {
		...
		plugins: [
			copy({
				targets: [
					{ src: "node_modules/pdfjs-dist/build/pdf.worker.min.js", dest: `${distDir}/pdfjs` },
					{ src: "node_modules/pdfjs-dist/cmaps/**/*", dest: `${distDir}/pdfjs/cmaps` },
